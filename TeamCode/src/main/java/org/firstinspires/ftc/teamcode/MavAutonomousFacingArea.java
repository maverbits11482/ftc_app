...
@Autonomous(name = "ThreeBot Autonomous:Facing Square", group = "MavAutonomous")
@Disabled
public class MavAutonomousFacingArea extends LinearOpMode
{
...
//        threeBot.motorRight.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
        ...
        // End of Object tracking and positioning.

        endAngle = getAngle();

        RobotLog.vv("HCE", "" + (endAngle - startAngle));
